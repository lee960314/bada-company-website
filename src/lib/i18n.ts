...
const fallbackResources = {
  ...
  ko: {
    ...
    "process_step_heat_sealing_desc": "용제 없이 압력 하에서 기질을 결합하여 강력한 접착력과 지속가능성을 보장합니다.",
      ...
      "about_visit_facility": "우리 시설 방문",
      "about_facility_description": "서울 비즈니스 지역의 중심에 위치한 우리의 현대적인 시설은 접근이 용이하며 최첨단 제조 장비를 갖추고 있습니다",
  ...
  'zh-CN': {
    common: {
      ...
      "about_visit_facility": "参观我们的设施",
      "about_facility_description": "我们位于首尔商业区中心的现代化设施交通便利，配备最先进的制造设备",
      ...
      "quote_refrigerated_frozen": "冷藏/冷冻",
      "quote_function_refrigerated": "冷藏/冷冻",
      "quote_sterilized_retort": "杀菌蒸煮",
