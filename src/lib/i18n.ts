...
const fallbackResources = {
  ...
  'zh-CN': {
    common: {
      ...
      "about_company_intro_1": "成立于2003年的KJ FLEX PACK是一家全球制造企业，为食品、饮料、宠物护理、家居用品和个人护理领域的主要品牌提供柔性包装解决方案。",
      "about_company_intro_2": "配备高速9色印刷、无溶剂层压和智能制造系统，我们提供确保产品安全性、陈列吸引力和供应链效率的包装。",
      "about_company_intro_3": "凭借对创新和可持续性的承诺，我们提供环保高阻隔包装解决方案，增强合作伙伴在全球市场的竞争力。",
